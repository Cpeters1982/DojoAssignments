...
RSpec.describe Stringer do
  ...
  it "has method minify that will shorten string to max length and add ..., or return original if less than max length" do
  ...
  it 'has method to iterate over string and replace each instance of a word with the replacement provided' do
    expect(Stringer.replacify("I can't do this", "can't", "can")).to eq("I can do this")
    expect(Stringer.replacify("I can't do this", "cant", "can")).to eq("I can't do this")
  end

  it 'has method to iterate over string, add each word to array and then return the array' do
    expect(Stringer.tokenize("I love to code")).to eq(["I", "love", "to", "code"])
  end

  it 'has method removify that removes each instance of the second string parameter from the first string parameter' do
